...
// hier kann bestimmt noch was raus. ich hab bloß pauschal mal alles reingemacht :D
...
public class Cube3D extends Application {
    ...
    public Node create3dContent() {
        ...
        Cube c = new Cube(Integer.parseInt(JOptionPane.showInputDialog("Welche Größe (px) soll das rote haben?: ")),Color.RED,1);
        c.rx.setAngle(45);
        c.ry.setAngle(45);
        Cube c2 = new Cube(Integer.parseInt(JOptionPane.showInputDialog("Welche Größe soll der grüne Würfel haben?: ")),Color.GREEN,1);
        c2.setTranslateX(100);
        c2.rx.setAngle(45);
        c2.ry.setAngle(45);
        Cube c3 = new Cube(Integer.parseInt(JOptionPane.showInputDialog("Welche Größe soll der gelbe Würfel haben?")),Color.YELLOW,1);
    ...
    public static void main(String[] args) {
       // Scanner sc = new Scanner(System.in); Hab das oben direkt eingebunden :D
        launch(args);
    }
}
